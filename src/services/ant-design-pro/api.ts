...
/** 条件搜索接口 POST /api/user/selectSearch */
export async function selectSearch(body: API.searchUser, options?: { [key: string]: any }) {
  return request<API.BaseResponse<API.RegisterResult>>('/api/user/selectSearch', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function deleteUser(options?: { id: number; [key: string]: any }) {
